...
- [ ] Every behaviour this PR adds or changes is tested here, error paths and branches included (bats in `test/`, `node:test` for `packages/dev-config` and the Node scripts); the tests are named above
