...
<sub><!--count:reusable-workflows-->15<!--/count--> reusable workflows · <!--count:scripts-->90<!--/count--> scripts · <!--count:tests-->622<!--/count--> tests · one pinned tag · one npm package</sub>
...
| `test/`                | <!--count:bats-files-->71<!--/count--> bats files, <!--count:tests-->622<!--/count--> tests, plus `fixtures/consumer-min/` — the caller the docs are held to                                 |
