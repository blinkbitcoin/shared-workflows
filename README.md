...
<sub><!--count:reusable-workflows-->15<!--/count--> reusable workflows · <!--count:scripts-->89<!--/count--> scripts · <!--count:tests-->563<!--/count--> tests · one pinned tag · one npm package</sub>
...
| `test/`                | <!--count:bats-files-->64<!--/count--> bats files, <!--count:tests-->563<!--/count--> tests, plus `fixtures/consumer-min/` — the caller the docs are held to                                 |
