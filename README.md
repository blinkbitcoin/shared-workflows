...
<sub><!--count:reusable-workflows-->16<!--/count--> reusable workflows · <!--count:scripts-->94<!--/count--> scripts · <!--count:tests-->642<!--/count--> tests · one pinned tag · one npm package</sub>
...
| `test/`                | <!--count:bats-files-->72<!--/count--> bats files, <!--count:tests-->642<!--/count--> tests, plus `fixtures/consumer-min/` — the caller the docs are held to                                 |
