...
<sub><!--count:reusable-workflows-->16<!--/count--> reusable workflows · <!--count:scripts-->99<!--/count--> scripts · <!--count:tests-->1035<!--/count--> tests · one pinned tag · one npm package</sub>
...
<!--count:shell-scripts-->97<!--/count--> shell scripts: install an Android SDK, boot an emulator that does not
...
| `test/`                | <!--count:bats-files-->110<!--/count--> bats files, <!--count:tests-->1035<!--/count--> tests, plus `fixtures/consumer-min/` — the caller the docs are held to                                 |
